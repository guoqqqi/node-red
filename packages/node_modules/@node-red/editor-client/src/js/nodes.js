...
RED.nodes = (function() {
    ...
    function importNodes(newNodesObj,options) { // createNewIds,createMissingWorkspace) {
        ...
        // check if flow ID in location hash has been created
        const serviceData = window.location.hash.replace("#flow/", "")
        const flowId = serviceData.split('?name=')[0];
        const flowName = decodeURI(serviceData.split('?name=')[1]) || `flow_${flowId}`;
        ...
        // create new workspace named service name
        if (defaultWorkspace == null) {
            defaultWorkspace = { type:"tab", id: flowId, disabled: false, info:"",  label: flowName, env:[]};
