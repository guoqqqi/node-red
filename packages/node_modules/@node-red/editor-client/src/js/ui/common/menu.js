...
RED.menu = (function() {
    ...
    function createMenuItem(opt) {
        ...
        // Hidden the top menu
        $('#red-ui-header-button-sidemenu').css('display', 'none');
        $('#red-ui-header').css({'display': 'flex', 'justify-content': 'space-between', 'align-items': 'center'});
        $('#red-ui-tab-config-link-button').css('display', 'none');
        $('#red-ui-tabs-menu-option-config').css('display', 'none');

        $('.red-ui-tabs-add').children('a').css('pointer-events', 'none').children('i').css('display', 'none');
        $('.red-ui-tabs-menu').children('a').css('pointer-events', 'none').children('i').css('display', 'none');
